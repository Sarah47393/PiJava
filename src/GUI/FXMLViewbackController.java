 ...
 * @author HP
 */
public class FXMLViewbackController implements Initializable {
    ...
    @FXML
    private void userback(ActionEvent event) throws Exception {
    ...
    @FXML
    private void emploisback(ActionEvent event) throws Exception{
